...
class AsyncOrders:
    ...
    async def lookup(self, order_id: str, **options):
        ...
        return _resource(await self.http.post('/orders/lookup', body), 'order', Order)
    ...
    async def update(self, payload: dict):
        ...
        Returns:
            The updated Order.
        """
        return _resource(await self.http.post('/orders/update', payload), 'order', Order)
    ...
    async def pay(self, payload: dict):
        ...
        """
        return _resource(await self.http.post('/orders/pay', payload), 'order', Order)

    async def confirm_payment(self, payload: dict):
        """
        ...
        See Also:
            ...
            - https://studio.inttegro.com/charge-repeat-customers
        """
        return _resource(await self.http.post('/orders/confirm_payment', payload), 'order', Order)

    async def request_confirmation(self, order_id: str, request_meta: dict | None=None):
        """
        ...
        """
        return _resource(await self.http.post('/orders/request_confirmation', {'order_id': order_id, 'request_meta': request_meta or _stable_order_request_meta('request_confirmation', order_id)}), 'order', Order)

    async def finalize(self, order_id: str, request_meta: dict | None=None):
        """
        ...
        """
        return _resource(await self.http.post('/orders/finalize', {'order_id': order_id, 'request_meta': request_meta or _stable_order_request_meta('finalize', order_id)}), 'order', Order)

    async def send_invoice(self, payload: dict):
        """
        ...
        """
        return await self.http.post('/orders/send_invoice', payload)

    async def send_receipt(self, payload: dict):
        """
        ...
        Returns:
            An OrderDocumentDeliveryResult containing the order and delivery details.
        """
        return await self.http.post('/orders/send_receipt', payload)
    ...
    async def complete(self, payload: dict):
        ...
        """
        return _resource(await self.http.post('/orders/complete', payload), 'order', Order)

    async def cancel(self, order_id: str, request_meta: dict | None=None):
        """
