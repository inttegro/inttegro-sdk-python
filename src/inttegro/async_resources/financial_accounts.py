...
class AsyncFinancialAccounts:
    ...
    async def create(self, payload: dict):
        ...
        """
        return await self.http.post('/financial_accounts/create', payload)

    async def lookup(self, account_id: str):
        """
        ...
        """
        return await self.http.post('/financial_accounts/lookup', {'account_id': account_id})
    ...
    async def connect(self, payload: dict):
        ...
        """
        return await self.http.post('/financial_accounts/connect', payload)

    async def archive(self, payload: dict):
        """
        ...
        """
        return await self.http.post('/financial_accounts/archive', payload)
    ...
    async def verify(self, payload: dict):
        ...
        """
        return await self.http.post('/financial_accounts/verify', payload)
    ...
    async def disable_push(self, account_id: str, unset_as_payout_destination: bool | None=None):
        ...
        return await self.http.post('/financial_accounts/disable_push', payload)

    async def disconnect(self, account_id: str, unset_as_payout_destination: bool | None=None):
        """
        ...
        if unset_as_payout_destination is not None:
            payload['unset_as_payout_destination'] = unset_as_payout_destination
        return await self.http.post('/financial_accounts/disconnect', payload)
